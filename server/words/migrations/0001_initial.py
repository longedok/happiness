    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('topic', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='words', to='words.topic', verbose_name='topic')),
                ('user', models.ManyToManyField(through='words.UserWord', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Word',
